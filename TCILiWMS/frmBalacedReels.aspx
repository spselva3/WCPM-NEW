<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmBalacedReels.aspx.cs" Inherits="WCPM.frmBalacedReels" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <script type="text/javascript">
       function PrintDiv() {
           ...
           printWindow.document.write('<html><head><title> Balance Reel Report</title>');
