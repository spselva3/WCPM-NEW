...
namespace WCPM
{
    public partial class frmGsmMaster : System.Web.UI.Page
    {
        ...
        private void GetLabelledData()
        {
            try
            {
                ...
                DataSet ds = MSSQLHelper.ExecSqlDataSet("SP_SELECTGSMMASTER", CommandType.StoredProcedure, new List<SqlParameter>()
                 {
