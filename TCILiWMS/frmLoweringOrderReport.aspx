<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmLoweringOrderReport.aspx.cs" Inherits="WCPM.frmLoweringOrderReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function PrintDiv() {
             ...
             printWindow.document.write('<html><head><title>Daily Reels Report</title>');
    ...
    <script language="javascript">
        function Changed(textControl) {
            ...
            document.getElementById("<%= txtToMachineNUmber.ClientID %>").value = textControl.value
        }
    </script>
    <script language="Javascript">
    ...
    <div id="dvgridheading" style="height: 20px;">
        ...
        <table style="width: 900px;">
            <tr>
                ...
                <th>
                    <asp:DropDownList ID="ddlFromShift" runat="server" Width="50px" align="left" BackColor="White">
                ...
                <th aligh="left">
                 ...
                 <th>
                    <asp:DropDownList ID="ddlToShift" runat="server" Width="50px" align="left" BackColor="White">
                                <asp:ListItem Text="Please Select" Value="Please Select"></asp:ListItem>
                ...
                <th aligh="left">
                    <asp:Label ID="label2" Text="From M/C" runat="server"></asp:Label>

                </th>
                <th>

                    <asp:TextBox ID="txtFromMachineNUmber" runat="server" onkeypress="return isNumberKey(event)" onchange="javascript: Changed( this )" AutoCompleteType="Disabled"></asp:TextBox>

                </th>
                <th aligh="left">
                    <asp:Label ID="label3" Text=" To M/C" runat="server"></asp:Label>

                </th>
                <th>

                    <asp:TextBox ID="txtToMachineNUmber" onkeypress="return isNumberKey(event)" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
