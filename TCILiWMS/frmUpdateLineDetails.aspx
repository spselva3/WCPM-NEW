<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUpdateLineDetails.aspx.cs" Inherits="WCPM.frmUpdateLineDetails" %>
            ...
            <table width="100%" cellpadding="6" cellspacing="0" border="0">
                <tr>
                    <th align="center" style="background-color: #003399; color: White; font-weight: bold;"
                        valign="top">Update Line&nbsp; Details</th>
                </tr>
            </table>
            <div>
            </div>
            ...
            <div id="detailsMain">
                <table width="100%" cellpadding="6" cellspacing="0" border="0">
                    <tr>
                        <th>Line No.</th>
                        <th>
                            <asp:TextBox ID="txtLineNUmber" runat="server" ReadOnly="True" BackColor="White"></asp:TextBox>
                        </th>
                        <th></th>
                        <th>Line Name</th>
                        <th>
                            <asp:TextBox ID="txtLineName" runat="server" AutoPostBack="false" BackColor="White"></asp:TextBox>
                        </th>
                    </tr>
                    <tr>
                        <th>Line Description</th>
                         <th>
                            <asp:TextBox ID="txtLineDescription" runat="server" AutoPostBack="false" BackColor="White"></asp:TextBox>
                        </th>
                        <th></th>
                        <th>&nbsp;</th>
                        <th>
                ...
                <table>
                    <tr>
                        ...
                        <th style="padding-left: 325px" class="auto-style1">
                            <asp:Button runat="server" ID="btnsubmit" OnClick="btnsubmit_Click" OnClientClick="if(!ValidateData()) return false;" Text="Update" Height="30px" />
                            &nbsp;&nbsp;
                           <asp:Button runat="server" ID="btnClear" OnClick="btnClear_Click" Text="Clear" Height="30px"  />
                            &nbsp;&nbsp;
                            <asp:Button runat="server" ID="BtnClose" Text="Close" OnClientClick="ClosePupup()" Height="30px"  />
                        </th>
