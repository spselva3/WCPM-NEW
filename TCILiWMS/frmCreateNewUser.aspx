<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreateNewUser.aspx.cs" Inherits="WCPM.frmCreateNewUser" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateData() {
            ...
            x1 = document.getElementById("txtEmpName").value;
            ...
            x4 = document.getElementById("txtEmpid").value;
            ...
            var e = document.getElementById("ddlRole");
            ...
            x2 = document.getElementById("txtUserame").value;
            ...
            x3 = document.getElementById("txtPassword").value;
            ...
            var e1 = document.getElementById("ddlStatus");
            ...
            <div id="detailsMain">
                <table width="100%" cellpadding="6" cellspacing="0" border="0">
                    <tr>
                        ...
                        <th>
                            <asp:TextBox ID="txtEmpid" runat="server" AutoPostBack="false" align="left" BackColor="White"></asp:TextBox>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <asp:TextBox ID="txtUserame" runat="server" align="left" BackColor="White"></asp:TextBox>
                        </th>
                    </tr>
                    <tr>
                        <th align="left">Password</th>
                        <th>
                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" align="left" BackColor="White"></asp:TextBox>
                        </th>
                        <th></th>
                ...
                <table>
                    <tr>
                        ...
                        <th style="padding-left: 325px" class="auto-style1">
                            <asp:Button runat="server" ID="btnsubmit" OnClick="btnsubmit_Click" OnClientClick="if(!ValidateData()) return false;" Text="Create User" Height="30px" />
                            &nbsp;&nbsp;
                           <asp:Button runat="server" ID="btnClear" OnClick="btnClear_Click" Text="Clear" Style="width: 46px" Height="30px" />
                            &nbsp;&nbsp;
                            <asp:Button runat="server" ID="BtnClose" Text="Close" OnClientClick="ClosePupup()"  Height="30px" OnClick="BtnClose_Click" Width="49px"/>
                        </th>
