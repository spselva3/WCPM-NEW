<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmQualityMaster.aspx.cs" Inherits="WCPM.frmQualityMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ShowDispatchPlanCreation() {
            ...
            window.open('frmAddQcMaster.aspx', 'AllCustomers', 'location=1,status=1,resizable=no,statusbar=0,menubar=0,toolbar=0,scrollbars=2,width=800,height=130,left=' + x + ',top=' + y);
        }
    </script>
