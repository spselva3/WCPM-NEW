<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmUsers.aspx.cs" Inherits="WCPM.frmUsers" %>
...
<asp:Content ID="UserContentHead" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowEditWindow(id) {
            ...
            window.open('frmUpdateUser.aspx?data=' + id, 'AllCustomers', 'location=1,status=1,resizable=no,scrollbars=2,width=800,height=230,left=' + x + ',top=' + y);
            return false;
        }
        ...
        //    var y = screen.height / 2 - 400 / 2;
        //    //window.open(meh.href, 'sharegplus', 'height=485,width=700,left=' + x + ',top=' + y);
        //    window.open('frmUpdateUser.aspx?data='+url, 'AllCustomers', 'location=1,status=1,resizable=no,scrollbars=2,width=800,height=200,left=' + x + ',top=' + y);
        //}
    </script>
...
<asp:Content ID="UserContentBody" ContentPlaceHolderID="rightcontent" runat="server">
    ...
    <div id="gridcontainer">
        <asp:ListView ID="lvUserDetails" runat="server" ispostback="false">
            <%--OnItemEditing="lvUserDetails_ItemEditing" OnItemUpdating="lvUserDetails_ItemUpdating" OnItemCanceling="lvUserDetails_ItemCanceling" OnItemDataBound="lvUserDetails_ItemDataBound" OnItemCommand="lvUserDetails_ItemCommand" OnSelectedIndexChanged="lvUserDetails_SelectedIndexChanged">--%>
            <LayoutTemplate>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%--  <asp:Button ID="BtnEdit" Text="Edit" runat="server" CommandName="EditDetails" OnClientClick='return ShowEditWindow( "<%# Eval("ID") %>" )' /></td>--%>
                        <a href="#" id="id123" onclick="ShowEditWindow('<%# Eval("ID")%>'); ">
